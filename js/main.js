...
(function($) {
    ...
    var cfg = {
        ...
        mailChimpURL   : 'https://gmail.us8.list-manage.com/subscribe/post?u=87aa6df353c82a20bf30df972&amp;id=6e8d2abd61&amp;f_id=001709e0f0"'   // mailchimp url
    },
    ...
    * ------------------------------------------------------ */
    var ssFinalCountdown = function() {
        ...
        var finalDate =  new Date("February 29, 2024 00:00:00").getTime();
        //-date: "Mar 25 2021",
    ...
    * ------------------------------------------------------ */
    var ssAjaxChimp = function() {
        ...
        $.ajaxChimp.translations.es = {
            'submit': 'Submitting...',
            0: '<i class="fas fa-check"></i> Thank you for signing up! We will keep sending you the latest updates.',
